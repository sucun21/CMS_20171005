...
<!DOCTYPE html>
<html ng-app="app.preview" ng-cloak>
<head>
	...
	<c:choose>
	    <c:when test="${CommonUtils.runningEnvironment ne 'dev'}">
	    	<link rel="stylesheet" type="text/css" href="/preview/build/app.min.css?v=${CommonUtils.version}">
	    </c:when>
	    <c:otherwise>
...
<body ng-controller="Catalouge.Preview as vm" ng-init="init(${unitId}, ${lessonId}, ${activityId})">
...
<c:choose>
    <c:when test="${CommonUtils.runningEnvironment ne 'dev'}">
    	<script type="text/javascript" src="/preview/build/libs.min.js?v=${CommonUtils.version}"></script>
    	<script type="text/javascript" src="/preview/build/app.min.js?v=${CommonUtils.version}"></script>
    </c:when>
    <c:otherwise>
    	<script type="text/javascript" src="/preview/build/libs.min.js?v=${CommonUtils.version}"></script>
		<script type="text/javascript" src="/preview/app.js"></script>
		<script type="text/javascript" src="/preview/app.filters.js"></script>
		<script type="text/javascript" src="/preview/controllers/preview.js"></script>
		<script type="text/javascript" src="/preview/services/previewService.js"></script>
    </c:otherwise>
</c:choose>
</html>
