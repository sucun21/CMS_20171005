...
app.directive('courseImagePicker', ['$timeout', function($timeout){
	return{
		restrict: 'E',
		scope:{
			isEnable: '=',
		...
		templateUrl: 'app/components/courseImagePicker.html',
        link: function(scope, element, attrs) {
        	...
        	scope.onSelectCourseImage = function(ele){        		
        		...
        		if(file){
	    	        ...
	    	        reader.onload = function () {    	        	
	    	        	$timeout(function(){
	    	        		scope.courseImage = reader.result;
	    	        	});
	    	        };
...
app.directive('timepicker', function(){
	return {
	    ...
	    require: 'ngModel',
	    replace: true,
	    templateUrl: 'app/components/timepicker.html',
	    scope: {
	    	timeFormat: '@',
			minuteStepping: '@',
			placeholder:'@',
...
app.directive('fcEvent', function(){
	return {
	    restrict: 'E',
	    replace: true,
	    templateUrl: 'app/components/fc-event.html',
	    scope: {
			event: '=',
			style: '@',
			isAdmin: '='
...
app.directive('pagination', ['$rootScope', '$state', function($rootScope, $state){
	return {
	    restrict: 'E',
	    replace: true,
	    templateUrl: 'app/components/paging.html',
	    scope: {
	    	params: '=',
	    	totalRow: '='
		},
