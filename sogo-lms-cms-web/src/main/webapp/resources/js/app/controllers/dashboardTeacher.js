function dashboardTeacherCtrl($scope, $rootScope, $q, $state, $compile, sessionService, dataService, $timeout, progressService) {
	var vm = this;
...
app.controller('dashboardTeacherCtrl', dashboardTeacherCtrl);